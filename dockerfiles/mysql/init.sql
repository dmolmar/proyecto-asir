CREATE DATABASE IF NOT EXISTS foroarc;
USE foroarc;
...
INSERT INTO `usuarios` (`id_usuario`, `id_rol`, `nombre_usuario`, `correo_electronico`, `contrasena`, `cita`, `biografia`, `ubicacion`, `fecha_nacimiento`, `estado`) 
VALUES (1, 1, 'cuentatest', 'cuentatest@gmail.com', 'cuentatest', '', 'No se', '', '', 1);